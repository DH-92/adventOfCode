...
function solveInput(inputFile,player1,player2) {
    let nodes =
...
console.log(`example output: ${solveInput(EXAMPLE_FILE,4,8)}  -- expect 739785`)
console.log(`final   output: ${solveInput(QUESTION_FILE,10,1)}  -- expect 920079`)
