...
// console.log(`${8} | ${3},${5} => ${calculatePower(8, 3, 5)}`);
// console.log(`${57} | ${122},${79} => ${calculatePower(57, 122, 79)}`);
// console.log(`${39} | ${217},${196} => ${calculatePower(39, 217, 196)}`);
// console.log(`${71} | ${101},${153} => ${calculatePower(71, 101, 153)}`);
