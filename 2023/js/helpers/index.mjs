...
export const product = (acc, cal) => acc * cal
...
export const intDiv = (numerator, divisor) => [Math.floor(numerator / divisor), numerator % divisor]
...
export const transpose = matrix =>
  matrix.reduce((prev, next) => next.map((_, i) => (prev[i] ?? []).concat(next[i])), [])
